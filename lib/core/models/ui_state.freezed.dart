...
/// @nodoc
class __$initCopyWithImpl<T, $Res> extends _$UiStateCopyWithImpl<T, $Res>
...
abstract class _init<T> extends UiState<T> {
...
/// @nodoc
class __$successCopyWithImpl<T, $Res> extends _$UiStateCopyWithImpl<T, $Res>
...
abstract class _success<T> extends UiState<T> {
...
class _$_error<T> extends _error<T> {
  ...
  @override
  String toString() {
    return 'UiState<$T>.error(exception: $exception)';
  }
